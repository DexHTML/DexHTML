...
<img src="../assets/case-studies/duty-schedule/duty-schedule-calendar.png" width="900" alt="Duty Schedule — месячный график">

*Месячная матрица объединяет рабочие часы, дежурства, компенсационные и выходные дни.*

<img src="../assets/case-studies/duty-schedule/duty-schedule-today.png" width="900" alt="Duty Schedule — оперативная доступность сотрудников">

*Оперативная витрина показывает доступность сотрудников и причину временной недоступности.*

На изображениях реальные имена, подразделения и производственные показатели заменены демонстрационными значениями.
